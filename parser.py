...
translations = [("s","south"), ("n","north"), ("w","west"), ("e","east"),
("go", "move"), ("i", "inventory"), ("u", "up"), ("d", "down")]
prepositions = ['at', 'to']
    ...
    if words[0] in verbs:
        ...
        if words[0] == "move":
            ...
            if obj in player.location.actors:
                ...
                print(f"You try striking up a conversation with {obj.name}, but it seems unresponsive.")
        elif words[0] == "open":
            if obj in player.location.things:
